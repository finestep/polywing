...
public class ShipCollide : MonoBehaviour {
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        if (collision.gameObject.CompareTag("Terrain"))
        {
            ...
            {
                rb.AddForce(collision.relativeVelocity.magnitude * 0.2f * collision.contacts[0].normal, ForceMode2D.Impulse);
                rb.AddForce(collision.relativeVelocity.magnitude * -0.4f * rb.velocity.normalized, ForceMode2D.Impulse);
